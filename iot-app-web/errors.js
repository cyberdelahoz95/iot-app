...
class NoProperEventEmittersInParameters extends Error {
  constructor (...params) {
            // Pass remaining arguments (including vendor specific ones) to parent constructor
    super(...params)
    ...
    this.message = `Please pass EventEmitters as arguments`
  }
        }
module.exports = {NoProperEventEmittersInParameters, AgentNotFoundError, NotAuthenticatedError, NotAuthorizedError, MetricsNotFoundError, GeneralIoTApiError}
